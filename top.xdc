...
create_generated_clock -name clk_x2     [get_pins i_hyperram_wrapper/i_clk_hr/i_clk_hyperram/CLKOUT1]
create_generated_clock -name clk_x2_del [get_pins i_hyperram_wrapper/i_clk_hr/i_clk_hyperram/CLKOUT2]
create_generated_clock -name clk_x1     [get_pins i_hyperram_wrapper/i_clk_hr/i_clk_hyperram/CLKOUT3]
...
create_generated_clock -name o_clk      [get_pins i_hdmi_wrapper/i_clk_hdmi/i_clk_hdmi/CLKOUT1]
create_generated_clock -name hdmi_clk   [get_pins i_hdmi_wrapper/i_clk_hdmi/i_clk_hdmi/CLKOUT2]
...
set_false_path -from [get_clocks clk_x1]   -to [get_clocks i_clk]
...
set_false_path -from [get_clocks i_clk]    -to [get_clocks o_clk]
set_false_path   -to [get_clocks i_clk]  -from [get_clocks o_clk]
