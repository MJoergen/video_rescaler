...
########### MEGA65 timing ################
# Rename autogenerated clocks
create_generated_clock -name pixel_clk  [get_pins i_clk_hdmi/i_clk_hdmi/CLKOUT1]
create_generated_clock -name pixel_clk5 [get_pins i_clk_hdmi/i_clk_hdmi/CLKOUT2]
