...
create_generated_clock -name clk_x2     [get_pins i_clk_hr/i_clk_hyperram/CLKOUT1]
create_generated_clock -name clk_x2_del [get_pins i_clk_hr/i_clk_hyperram/CLKOUT2]
create_generated_clock -name clk_x1     [get_pins i_clk_hr/i_clk_hyperram/CLKOUT3]
...
########### MEGA65 timing ################
# Rename autogenerated clocks
create_generated_clock -name pixel_clk  [get_pins i_clk_hdmi/i_clk_hdmi/i_clk_mega65/CLKOUT1]
create_generated_clock -name pixel_clk5 [get_pins i_clk_hdmi/i_clk_hdmi/i_clk_mega65/CLKOUT2]
